...
const SCENES = {
  ...
  egg:         { create: createEgg,        label: 'Orbiter — Aurorae, Magnetic Field, Satellites.',
                 ariaLabel: 'Orbiter — Earth’s magnetic field, the aurorae it produces, and satellites in orbit. Drag to orbit.' },
