...
export const BIBLIOGRAPHY = [
  ...
  },
  {
    ...
    entries: [
      'Essays and short fiction, Scott Cohen, 2000s–2010s. Includes "In The End It Falls Slowly Through The Aether," from Cartography.doc — originally staged as its own scene (Leaf), folded into the scroll 2026-08-07 when that scene was retired for good.',
    ],
  },
  {
    scene: 'The Theater',
