...
import '../../styles/scenes/scroll.css';
...
// Scroll's CSS lives in styles/scenes/scroll.css (imported above) —
...
// globally — this one still has to happen at runtime (it's a DOM fragment
// with actual SVG elements, not CSS), guarded the same way the old
// buildStyles() injection used to be.
