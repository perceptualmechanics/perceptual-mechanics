...
import '../../styles/scenes/orrery.css';
...
// page can't drift.
import { ORRERY } from '../text/orreryStory.js';
...
export function createOrrery(container, { preview = false } = {}) {
  ...
  // Panel/hint/caption/title/crosshair/walkpad styles live in
  // styles/scenes/orrery.css — no runtime injection needed now that
  // it's a real stylesheet.
