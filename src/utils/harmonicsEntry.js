...
// Originally "harmonics entry points" (2026-08-16): ground-glimpse (a
...
// panel (src/scenes/harmonics/harmonics.js) still uses it to jump
// straight to either side of a resonance a visitor clicks through to, and
// it was never actually harmonics-specific to begin with (see its own
