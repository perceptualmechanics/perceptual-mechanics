...
}`,dm=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],fm=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],ll=new lt,Fi=new D,Ps=new D;function pm(i,e,t){let n=new Ha;const r=new Be,s=new Be,a=new ut,o=new bh,l=new Eh,c={},p=t.maxTextureSize,_={[Ln]:Lt,[Lt]:Ln,[fn]:fn},h=new on({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Be},radius:{value:4}},vertexShader:hm,fragmentShader:um}),g=h.clone();g.defines.HORIZONTAL_PASS=1;const x=new Pt;x.setAttribute("position",new St(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Yt(x,h),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Sr;let u=this.type;this.render=function(T,R,m){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||T.length===0)return;this.type===hc&&(Oe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Sr);const E=i.getRenderTarget(),L=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),O=i.state;O.setBlending(mn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const W=u!==this.type;W&&R.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(B=>B.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,B=T.length;K<B;K++){const Y=T[K],V=Y.shadow;if(V===void 0){Oe("WebGLShadowMap:",Y,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const $=V.getFrameExtents();r.multiply($),s.copy(V.mapSize),(r.x>p||r.y>p)&&(r.x>p&&(s.x=Math.floor(p/$.x),r.x=s.x*$.x,V.mapSize.x=s.x),r.y>p&&(s.y=Math.floor(p/$.y),r.y=s.y*$.y,V.mapSize.y=s.y));const ne=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=ne,V.map===null||W===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Oi){if(Y.isPointLight){Oe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new sn(r.x,r.y,{format:Xn,type:_n,minFilter:wt,magFilter:wt,generateMipmaps:!1}),V.map.texture.name=Y.name+".shadowMap",V.map.depthTexture=new yi(r.x,r.y,tn),V.map.depthTexture.name=Y.name+".shadowMapDepth",V.map.depthTexture.format=xn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=yt,V.map.depthTexture.magFilter=yt}else Y.isPointLight?(V.map=new Hl(r.x),V.map.depthTexture=new gh(r.x,an)):(V.map=new sn(r.x,r.y),V.map.depthTexture=new yi(r.x,r.y,an)),V.map.depthTexture.name=Y.name+".shadowMap",V.map.depthTexture.format=xn,this.type===Sr?(V.map.depthTexture.compareFunction=ne?Oa:Fa,V.map.depthTexture.minFilter=wt,V.map.depthTexture.magFilter=wt):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=yt,V.map.depthTexture.magFilter=yt);V.camera.updateProjectionMatrix()}const se=V.map.isWebGLCubeRenderTarget?6:1;for(let ce=0;ce<se;ce++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,ce),i.clear();else{ce===0&&(i.setRenderTarget(V.map),i.clear());const ye=V.getViewport(ce);a.set(s.x*ye.x,s.y*ye.y,s.x*ye.z,s.y*ye.w),O.viewport(a)}if(Y.isPointLight){const ye=V.camera,Ke=V.matrix,rt=Y.distance||ye.far;rt!==ye.far&&(ye.far=rt,ye.updateProjectionMatrix()),Fi.setFromMatrixPosition(Y.matrixWorld),ye.position.copy(Fi),Ps.copy(ye.position),Ps.add(dm[ce]),ye.up.copy(fm[ce]),ye.lookAt(Ps),ye.updateMatrixWorld(),Ke.makeTranslation(-Fi.x,-Fi.y,-Fi.z),ll.multiplyMatrices(ye.projectionMatrix,ye.matrixWorldInverse),V._frustum.setFromProjectionMatrix(ll,ye.coordinateSystem,ye.reversedDepth)}else V.updateMatrices(Y);n=V.getFrustum(),M(R,m,V.camera,Y,this.type)}V.isPointLightShadow!==!0&&this.type===Oi&&y(V,m),V.needsUpdate=!1}u=this.type,f.needsUpdate=!1,i.setRenderTarget(E,L,C)};function y(T,R){const m=e.update(S);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,g.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,g.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new sn(r.x,r.y,{format:Xn,type:_n})),h.uniforms.shadow_pass.value=T.map.depthTexture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(R,null,m,h,S,null),g.uniforms.shadow_pass.value=T.mapPass.texture,g.uniforms.resolution.value=T.mapSize,g.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(R,null,m,g,S,null)}function A(T,R,m,E){let L=null;const C=m.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(C!==void 0)L=C;else if(L=m.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const O=L.uuid,W=R.uuid;let K=c[O];K===void 0&&(K={},c[O]=K);let B=K[W];B===void 0&&(B=L.clone(),K[W]=B,R.addEventListener("dispose",w)),L=B}if(L.visible=R.visible,L.wireframe=R.wireframe,E===Oi?L.side=R.shadowSide!==null?R.shadowSide:R.side:L.side=R.shadowSide!==null?R.shadowSide:_[R.side],L.alphaMap=R.alphaMap,L.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,L.map=R.map,L.clipShadows=R.clipShadows,L.clippingPlanes=R.clippingPlanes,L.clipIntersection=R.clipIntersection,L.displacementMap=R.displacementMap,L.displacementScale=R.displacementScale,L.displacementBias=R.displacementBias,L.wireframeLinewidth=R.wireframeLinewidth,L.linewidth=R.linewidth,m.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const O=i.properties.get(L);O.light=m}return L}function M(T,R,m,E,L){if(T.visible===!1)return;if(T.layers.test(R.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&L===Oi)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(m.matrixWorldInverse,T.matrixWorld);const W=e.update(T),K=T.material;if(Array.isArray(K)){const B=W.groups;for(let Y=0,V=B.length;Y<V;Y++){const $=B[Y],ne=K[$.materialIndex];if(ne&&ne.visible){const se=A(T,ne,E,L);T.onBeforeShadow(i,T,R,m,W,se,$),i.renderBufferDirect(m,null,W,se,T,$),T.onAfterShadow(i,T,R,m,W,se,$)}}}else if(K.visible){const B=A(T,K,E,L);T.onBeforeShadow(i,T,R,m,W,B,null),i.renderBufferDirect(m,null,W,B,T,null),T.onAfterShadow(i,T,R,m,W,B,null)}}const O=T.children;for(let W=0,K=O.length;W<K;W++)M(O[W],R,m,E,L)}function w(T){T.target.removeEventListener("dispose",w);for(const m in c){const E=c[m],L=T.target.uuid;L in E&&(E[L].dispose(),delete E[L])}}}function mm(i,e){function t(){let I=!1;const ae=new ut;let Z=null;const de=new ut(0,0,0,0);return{setMask:function(Se){Z!==Se&&!I&&(i.colorMask(Se,Se,Se,Se),Z=Se)},setLocked:function(Se){I=Se},setClear:function(Se,ee,Pe,Ae,dt){dt===!0&&(Se*=Ae,ee*=Ae,Pe*=Ae),ae.set(Se,ee,Pe,Ae),de.equals(ae)===!1&&(i.clearColor(Se,ee,Pe,Ae),de.copy(ae))},reset:function(){I=!1,Z=null,de.set(-1,0,0,0)}}}function n(){let I=!1,ae=!1,Z=null,de=null,Se=null;return{setReversed:function(ee){if(ae!==ee){const Pe=e.get("EXT_clip_control");ee?Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.ZERO_TO_ONE_EXT):Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.NEGATIVE_ONE_TO_ONE_EXT),ae=ee;const Ae=Se;Se=null,this.setClear(Ae)}},getReversed:function(){return ae},setTest:function(ee){ee?Q(i.DEPTH_TEST):ve(i.DEPTH_TEST)},setMask:function(ee){Z!==ee&&!I&&(i.depthMask(ee),Z=ee)},setFunc:function(ee){if(ae&&(ee=Hc[ee]),de!==ee){switch(ee){case Ns:i.depthFunc(i.NEVER);break;case Fs:i.depthFunc(i.ALWAYS);break;case Os:i.depthFunc(i.LESS);break;case Mi:i.depthFunc(i.LEQUAL);break;case Bs:i.depthFunc(i.EQUAL);break;case zs:i.depthFunc(i.GEQUAL);break;case ks:i.depthFunc(i.GREATER);break;case Vs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}de=ee}},setLocked:function(ee){I=ee},setClear:function(ee){Se!==ee&&(Se=ee,ae&&(ee=1-ee),i.clearDepth(ee))},reset:function(){I=!1,Z=null,de=null,Se=null,ae=!1}}}function r(){let I=!1,ae=null,Z=null,de=null,Se=null,ee=null,Pe=null,Ae=null,dt=null;return{setTest:function(ct){I||(ct?Q(i.STENCIL_TEST):ve(i.STENCIL_TEST))},setMask:function(ct){ae!==ct&&!I&&(i.stencilMask(ct),ae=ct)},setFunc:function(ct,Kt,Zt){(Z!==ct||de!==Kt||Se!==Zt)&&(i.stencilFunc(ct,Kt,Zt),Z=ct,de=Kt,Se=Zt)},setOp:function(ct,Kt,Zt){(ee!==ct||Pe!==Kt||Ae!==Zt)&&(i.stencilOp(ct,Kt,Zt),ee=ct,Pe=Kt,Ae=Zt)},setLocked:function(ct){I=ct},setClear:function(ct){dt!==ct&&(i.clearStencil(ct),dt=ct)},reset:function(){I=!1,ae=null,Z=null,de=null,Se=null,ee=null,Pe=null,Ae=null,dt=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let p={},_={},h={},g=new WeakMap,x=[],S=null,f=!1,u=null,y=null,A=null,M=null,w=null,T=null,R=null,m=new Ne(0,0,0),E=0,L=!1,C=null,O=null,W=null,K=null,B=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,$=0;const ne=i.getParameter(i.VERSION);ne.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(ne)[1]),V=$>=1):ne.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),V=$>=2);let se=null,ce={};const ye=i.getParameter(i.SCISSOR_BOX),Ke=i.getParameter(i.VIEWPORT),rt=new ut().fromArray(ye),Ze=new ut().fromArray(Ke);function U(I,ae,Z,de){const Se=new Uint8Array(4),ee=i.createTexture();i.bindTexture(I,ee),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Pe=0;Pe<Z;Pe++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(ae,0,i.RGBA,1,1,de,0,i.RGBA,i.UNSIGNED_BYTE,Se):i.texImage2D(ae+Pe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Se);return ee}const te={};te[i.TEXTURE_2D]=U(i.TEXTURE_2D,i.TEXTURE_2D,1),te[i.TEXTURE_CUBE_MAP]=U(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[i.TEXTURE_2D_ARRAY]=U(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),te[i.TEXTURE_3D]=U(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(i.DEPTH_TEST),a.setFunc(Mi),fe(!1),we(ao),Q(i.CULL_FACE),re(mn);function Q(I){p[I]!==!0&&(i.enable(I),p[I]=!0)}function ve(I){p[I]!==!1&&(i.disable(I),p[I]=!1)}function Ce(I,ae){return h[I]!==ae?(i.bindFramebuffer(I,ae),h[I]=ae,I===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ae),I===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ae),!0):!1}function Me(I,ae){let Z=x,de=!1;if(I){Z=g.get(ae),Z===void 0&&(Z=[],g.set(ae,Z));const Se=I.textures;if(Z.length!==Se.length||Z[0]!==i.COLOR_ATTACHMENT0){for(let ee=0,Pe=Se.length;ee<Pe;ee++)Z[ee]=i.COLOR_ATTACHMENT0+ee;Z.length=Se.length,de=!0}}else Z[0]!==i.BACK&&(Z[0]=i.BACK,de=!0);de&&i.drawBuffers(Z)}function Te(I){return S!==I?(i.useProgram(I),S=I,!0):!1}const oe={[zn]:i.FUNC_ADD,[dc]:i.FUNC_SUBTRACT,[fc]:i.FUNC_REVERSE_SUBTRACT};oe[pc]=i.MIN,oe[mc]=i.MAX;const _e={[gc]:i.ZERO,[_c]:i.ONE,[xc]:i.SRC_COLOR,[Ds]:i.SRC_ALPHA,[Ec]:i.SRC_ALPHA_SATURATE,[yc]:i.DST_COLOR,[Mc]:i.DST_ALPHA,[vc]:i.ONE_MINUS_SRC_COLOR,[Us]:i.ONE_MINUS_SRC_ALPHA,[bc]:i.ONE_MINUS_DST_COLOR,[Sc]:i.ONE_MINUS_DST_ALPHA,[Tc]:i.CONSTANT_COLOR,[wc]:i.ONE_MINUS_CONSTANT_COLOR,[Ac]:i.CONSTANT_ALPHA,[Rc]:i.ONE_MINUS_CONSTANT_ALPHA};function re(I,ae,Z,de,Se,ee,Pe,Ae,dt,ct){if(I===mn){f===!0&&(ve(i.BLEND),f=!1);return}if(f===!1&&(Q(i.BLEND),f=!0),I!==uc){if(I!==u||ct!==L){if((y!==zn||w!==zn)&&(i.blendEquation(i.FUNC_ADD),y=zn,w=zn),ct)switch(I){case _i:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ar:i.blendFunc(i.ONE,i.ONE);break;case oo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case lo:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:$e("WebGLState: Invalid blending: ",I);break}else switch(I){case _i:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ar:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case oo:$e("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case lo:$e("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:$e("WebGLState: Invalid blending: ",I);break}A=null,M=null,T=null,R=null,m.set(0,0,0),E=0,u=I,L=ct}return}Se=Se||ae,ee=ee||Z,Pe=Pe||de,(ae!==y||Se!==w)&&(i.blendEquationSeparate(oe[ae],oe[Se]),y=ae,w=Se),(Z!==A||de!==M||ee!==T||Pe!==R)&&(i.blendFuncSeparate(_e[Z],_e[de],_e[ee],_e[Pe]),A=Z,M=de,T=ee,R=Pe),(Ae.equals(m)===!1||dt!==E)&&(i.blendColor(Ae.r,Ae.g,Ae.b,dt),m.copy(Ae),E=dt),u=I,L=!1}function j(I,ae){I.side===fn?ve(i.CULL_FACE):Q(i.CULL_FACE);let Z=I.side===Lt;ae&&(Z=!Z),fe(Z),I.blending===_i&&I.transparent===!1?re(mn):re(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const de=I.stencilWrite;o.setTest(de),de&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Ye(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):ve(i.SAMPLE_ALPHA_TO_COVERAGE)}function fe(I){C!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),C=I)}function we(I){I!==lc?(Q(i.CULL_FACE),I!==O&&(I===ao?i.cullFace(i.BACK):I===cc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ve(i.CULL_FACE),O=I}function Ve(I){I!==W&&(V&&i.lineWidth(I),W=I)}function Ye(I,ae,Z){I?(Q(i.POLYGON_OFFSET_FILL),(K!==ae||B!==Z)&&(K=ae,B=Z,a.getReversed()&&(ae=-ae),i.polygonOffset(ae,Z))):ve(i.POLYGON_OFFSET_FILL)}function ke(I){I?Q(i.SCISSOR_TEST):ve(i.SCISSOR_TEST)}function et(I){I===void 0&&(I=i.TEXTURE0+Y-1),se!==I&&(i.activeTexture(I),se=I)}function P(I,ae,Z){Z===void 0&&(se===null?Z=i.TEXTURE0+Y-1:Z=se);let de=ce[Z];de===void 0&&(de={type:void 0,texture:void 0},ce[Z]=de),(de.type!==I||de.texture!==ae)&&(se!==Z&&(i.activeTexture(Z),se=Z),i.bindTexture(I,ae||te[I]),de.type=I,de.texture=ae)}function st(){const I=ce[se];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function We(){try{i.compressedTexImage2D(...arguments)}catch(I){$e("WebGLState:",I)}}function b(){try{i.compressedTexImage3D(...arguments)}catch(I){$e("WebGLState:",I)}}function d(){try{i.texSubImage2D(...arguments)}catch(I){$e("WebGLState:",I)}}function F(){try{i.texSubImage3D(...arguments)}catch(I){$e("WebGLState:",I)}}function z(){try{i.compressedTexSubImage2D(...arguments)}catch(I){$e("WebGLState:",I)}}function X(){try{i.compressedTexSubImage3D(...arguments)}catch(I){$e("WebGLState:",I)}}function ie(){try{i.texStorage2D(...arguments)}catch(I){$e("WebGLState:",I)}}function le(){try{i.texStorage3D(...arguments)}catch(I){$e("WebGLState:",I)}}function q(){try{i.texImage2D(...arguments)}catch(I){$e("WebGLState:",I)}}function J(){try{i.texImage3D(...arguments)}catch(I){$e("WebGLState:",I)}}function he(I){return _[I]!==void 0?_[I]:i.getParameter(I)}function Le(I,ae){_[I]!==ae&&(i.pixelStorei(I,ae),_[I]=ae)}function pe(I){rt.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),rt.copy(I))}function ue(I){Ze.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),Ze.copy(I))}function Ue(I,ae){let Z=c.get(ae);Z===void 0&&(Z=new WeakMap,c.set(ae,Z));let de=Z.get(I);de===void 0&&(de=i.getUniformBlockIndex(ae,I.name),Z.set(I,de))}function Fe(I,ae){const de=c.get(ae).get(I);l.get(ae)!==de&&(i.uniformBlockBinding(ae,de,I.__bindingPointIndex),l.set(ae,de))}function Ge(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),p={},_={},se=null,ce={},h={},g=new WeakMap,x=[],S=null,f=!1,u=null,y=null,A=null,M=null,w=null,T=null,R=null,m=new Ne(0,0,0),E=0,L=!1,C=null,O=null,W=null,K=null,B=null,rt.set(0,0,i.canvas.width,i.canvas.height),Ze.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Q,disable:ve,bindFramebuffer:Ce,drawBuffers:Me,useProgram:Te,setBlending:re,setMaterial:j,setFlipSided:fe,setCullFace:we,setLineWidth:Ve,setPolygonOffset:Ye,setScissorTest:ke,activeTexture:et,bindTexture:P,unbindTexture:st,compressedTexImage2D:We,compressedTexImage3D:b,texImage2D:q,texImage3D:J,pixelStorei:Le,getParameter:he,updateUBOMapping:Ue,uniformBlockBinding:Fe,texStorage2D:ie,texStorage3D:le,texSubImage2D:d,texSubImage3D:F,compressedTexSubImage2D:z,compressedTexSubImage3D:X,scissor:pe,viewport:ue,reset:Ge}}function gm(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Be,p=new WeakMap,_=new Set;let h;const g=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(b,d){return x?new OffscreenCanvas(b,d):Ir("canvas")}function f(b,d,F){let z=1;const X=We(b);if((X.width>F||X.height>F)&&(z=F/Math.max(X.width,X.height)),z<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const ie=Math.floor(z*X.width),le=Math.floor(z*X.height);h===void 0&&(h=S(ie,le));const q=d?S(ie,le):h;return q.width=ie,q.height=le,q.getContext("2d").drawImage(b,0,0,ie,le),Oe("WebGLRenderer: Texture has been resized from ("+X.width+"x"+X.height+") to ("+ie+"x"+le+")."),q}else return"data"in b&&Oe("WebGLRenderer: Image in DataTexture is too big ("+X.width+"x"+X.height+")."),b;return b}function u(b){return b.generateMipmaps}function y(b){i.generateMipmap(b)}function A(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(b,d,F,z,X,ie=!1){if(b!==null){if(i[b]!==void 0)return i[b];Oe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let le;z&&(le=e.get("EXT_texture_norm16"),le||Oe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let q=d;if(d===i.RED&&(F===i.FLOAT&&(q=i.R32F),F===i.HALF_FLOAT&&(q=i.R16F),F===i.UNSIGNED_BYTE&&(q=i.R8),F===i.UNSIGNED_SHORT&&le&&(q=le.R16_EXT),F===i.SHORT&&le&&(q=le.R16_SNORM_EXT)),d===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.R8UI),F===i.UNSIGNED_SHORT&&(q=i.R16UI),F===i.UNSIGNED_INT&&(q=i.R32UI),F===i.BYTE&&(q=i.R8I),F===i.SHORT&&(q=i.R16I),F===i.INT&&(q=i.R32I)),d===i.RG&&(F===i.FLOAT&&(q=i.RG32F),F===i.HALF_FLOAT&&(q=i.RG16F),F===i.UNSIGNED_BYTE&&(q=i.RG8),F===i.UNSIGNED_SHORT&&le&&(q=le.RG16_EXT),F===i.SHORT&&le&&(q=le.RG16_SNORM_EXT)),d===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RG8UI),F===i.UNSIGNED_SHORT&&(q=i.RG16UI),F===i.UNSIGNED_INT&&(q=i.RG32UI),F===i.BYTE&&(q=i.RG8I),F===i.SHORT&&(q=i.RG16I),F===i.INT&&(q=i.RG32I)),d===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGB8UI),F===i.UNSIGNED_SHORT&&(q=i.RGB16UI),F===i.UNSIGNED_INT&&(q=i.RGB32UI),F===i.BYTE&&(q=i.RGB8I),F===i.SHORT&&(q=i.RGB16I),F===i.INT&&(q=i.RGB32I)),d===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),F===i.UNSIGNED_INT&&(q=i.RGBA32UI),F===i.BYTE&&(q=i.RGBA8I),F===i.SHORT&&(q=i.RGBA16I),F===i.INT&&(q=i.RGBA32I)),d===i.RGB&&(F===i.UNSIGNED_SHORT&&le&&(q=le.RGB16_EXT),F===i.SHORT&&le&&(q=le.RGB16_SNORM_EXT),F===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),d===i.RGBA){const J=ie?Lr:Je.getTransfer(X);F===i.FLOAT&&(q=i.RGBA32F),F===i.HALF_FLOAT&&(q=i.RGBA16F),F===i.UNSIGNED_BYTE&&(q=J===tt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT&&le&&(q=le.RGBA16_EXT),F===i.SHORT&&le&&(q=le.RGBA16_SNORM_EXT),F===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function w(b,d){let F;return b?d===null||d===an||d===Gi?F=i.DEPTH24_STENCIL8:d===tn?F=i.DEPTH32F_STENCIL8:d===Vi&&(F=i.DEPTH24_STENCIL8,Oe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):d===null||d===an||d===Gi?F=i.DEPTH_COMPONENT24:d===tn?F=i.DEPTH_COMPONENT32F:d===Vi&&(F=i.DEPTH_COMPONENT16),F}function T(b,d){return u(b)===!0||b.isFramebufferTexture&&b.minFilter!==yt&&b.minFilter!==wt?Math.log2(Math.max(d.width,d.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?d.mipmaps.length:1}function R(b){const d=b.target;d.removeEventListener("dispose",R),E(d),d.isVideoTexture&&p.delete(d),d.isHTMLTexture&&_.delete(d)}function m(b){const d=b.target;d.removeEventListener("dispose",m),C(d)}function E(b){const d=n.get(b);if(d.__webglInit===void 0)return;const F=b.source,z=g.get(F);if(z){const X=z[d.__cacheKey];X.usedTimes--,X.usedTimes===0&&L(b),Object.keys(z).length===0&&g.delete(F)}n.remove(b)}function L(b){const d=n.get(b);i.deleteTexture(d.__webglTexture);const F=b.source,z=g.get(F);delete z[d.__cacheKey],a.memory.textures--}function C(b){const d=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(d.__webglFramebuffer[z]))for(let X=0;X<d.__webglFramebuffer[z].length;X++)i.deleteFramebuffer(d.__webglFramebuffer[z][X]);else i.deleteFramebuffer(d.__webglFramebuffer[z]);d.__webglDepthbuffer&&i.deleteRenderbuffer(d.__webglDepthbuffer[z])}else{if(Array.isArray(d.__webglFramebuffer))for(let z=0;z<d.__webglFramebuffer.length;z++)i.deleteFramebuffer(d.__webglFramebuffer[z]);else i.deleteFramebuffer(d.__webglFramebuffer);if(d.__webglDepthbuffer&&i.deleteRenderbuffer(d.__webglDepthbuffer),d.__webglMultisampledFramebuffer&&i.deleteFramebuffer(d.__webglMultisampledFramebuffer),d.__webglColorRenderbuffer)for(let z=0;z<d.__webglColorRenderbuffer.length;z++)d.__webglColorRenderbuffer[z]&&i.deleteRenderbuffer(d.__webglColorRenderbuffer[z]);d.__webglDepthRenderbuffer&&i.deleteRenderbuffer(d.__webglDepthRenderbuffer)}const F=b.textures;for(let z=0,X=F.length;z<X;z++){const ie=n.get(F[z]);ie.__webglTexture&&(i.deleteTexture(ie.__webglTexture),a.memory.textures--),n.remove(F[z])}n.remove(b)}let O=0;function W(){O=0}function K(){return O}function B(b){O=b}function Y(){const b=O;return b>=r.maxTextures&&Oe("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),O+=1,b}function V(b){const d=[];return d.push(b.wrapS),d.push(b.wrapT),d.push(b.wrapR||0),d.push(b.magFilter),d.push(b.minFilter),d.push(b.anisotropy),d.push(b.internalFormat),d.push(b.format),d.push(b.type),d.push(b.generateMipmaps),d.push(b.premultiplyAlpha),d.push(b.flipY),d.push(b.unpackAlignment),d.push(b.colorSpace),d.join()}function $(b,d){const F=n.get(b);if(b.isVideoTexture&&P(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&F.__version!==b.version){const z=b.image;if(z===null)Oe("WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)Oe("WebGLRenderer: Texture marked for update but image is incomplete");else{ve(F,b,d);return}}else b.isExternalTexture&&(F.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+d)}function ne(b,d){const F=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){ve(F,b,d);return}else b.isExternalTexture&&(F.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+d)}function se(b,d){const F=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&F.__version!==b.version){ve(F,b,d);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+d)}function ce(b,d){const F=n.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&F.__version!==b.version){Ce(F,b,d);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+d)}const ye={[Gs]:i.REPEAT,[pn]:i.CLAMP_TO_EDGE,[Hs]:i.MIRRORED_REPEAT},Ke={[yt]:i.NEAREST,[Lc]:i.NEAREST_MIPMAP_NEAREST,[Ki]:i.NEAREST_MIPMAP_LINEAR,[wt]:i.LINEAR,[Zr]:i.LINEAR_MIPMAP_NEAREST,[Vn]:i.LINEAR_MIPMAP_LINEAR},rt={[Uc]:i.NEVER,[zc]:i.ALWAYS,[Nc]:i.LESS,[Fa]:i.LEQUAL,[Fc]:i.EQUAL,[Oa]:i.GEQUAL,[Oc]:i.GREATER,[Bc]:i.NOTEQUAL};function Ze(b,d){if(d.type===tn&&e.has("OES_texture_float_linear")===!1&&(d.magFilter===wt||d.magFilter===Zr||d.magFilter===Ki||d.magFilter===Vn||d.minFilter===wt||d.minFilter===Zr||d.minFilter===Ki||d.minFilter===Vn)&&Oe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,ye[d.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,ye[d.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,ye[d.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,Ke[d.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,Ke[d.minFilter]),d.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,rt[d.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(d.magFilter===yt||d.minFilter!==Ki&&d.minFilter!==Vn||d.type===tn&&e.has("OES_texture_float_linear")===!1)return;if(d.anisotropy>1||n.get(d).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(d.anisotropy,r.getMaxAnisotropy())),n.get(d).__currentAnisotropy=d.anisotropy}}}function U(b,d){let F=!1;b.__webglInit===void 0&&(b.__webglInit=!0,d.addEventListener("dispose",R));const z=d.source;let X=g.get(z);X===void 0&&(X={},g.set(z,X));const ie=V(d);if(ie!==b.__cacheKey){X[ie]===void 0&&(X[ie]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),X[ie].usedTimes++;const le=X[b.__cacheKey];le!==void 0&&(X[b.__cacheKey].usedTimes--,le.usedTimes===0&&L(d)),b.__cacheKey=ie,b.__webglTexture=X[ie].texture}return F}function te(b,d,F){return Math.floor(Math.floor(b/F)/d)}function Q(b,d,F,z){const ie=b.updateRanges;if(ie.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,d.width,d.height,F,z,d.data);else{ie.sort((Le,pe)=>Le.start-pe.start);let le=0;for(let Le=1;Le<ie.length;Le++){const pe=ie[le],ue=ie[Le],Ue=pe.start+pe.count,Fe=te(ue.start,d.width,4),Ge=te(pe.start,d.width,4);ue.start<=Ue+1&&Fe===Ge&&te(ue.start+ue.count-1,d.width,4)===Fe?pe.count=Math.max(pe.count,ue.start+ue.count-pe.start):(++le,ie[le]=ue)}ie.length=le+1;const q=t.getParameter(i.UNPACK_ROW_LENGTH),J=t.getParameter(i.UNPACK_SKIP_PIXELS),he=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,d.width);for(let Le=0,pe=ie.length;Le<pe;Le++){const ue=ie[Le],Ue=Math.floor(ue.start/4),Fe=Math.ceil(ue.count/4),Ge=Ue%d.width,I=Math.floor(Ue/d.width),ae=Fe,Z=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ge),t.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Ge,I,ae,Z,F,z,d.data)}b.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,q),t.pixelStorei(i.UNPACK_SKIP_PIXELS,J),t.pixelStorei(i.UNPACK_SKIP_ROWS,he)}}function ve(b,d,F){let z=i.TEXTURE_2D;(d.isDataArrayTexture||d.isCompressedArrayTexture)&&(z=i.TEXTURE_2D_ARRAY),d.isData3DTexture&&(z=i.TEXTURE_3D);const X=U(b,d),ie=d.source;t.bindTexture(z,b.__webglTexture,i.TEXTURE0+F);const le=n.get(ie);if(ie.version!==le.__version||X===!0){if(t.activeTexture(i.TEXTURE0+F),(typeof ImageBitmap<"u"&&d.image instanceof ImageBitmap)===!1){const Z=Je.getPrimaries(Je.workingColorSpace),de=d.colorSpace===Rn?null:Je.getPrimaries(d.colorSpace),Se=d.colorSpace===Rn||Z===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,d.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,d.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se)}t.pixelStorei(i.UNPACK_ALIGNMENT,d.unpackAlignment);let J=f(d.image,!1,r.maxTextureSize);J=st(d,J);const he=s.convert(d.format,d.colorSpace),Le=s.convert(d.type);let pe=M(d.internalFormat,he,Le,d.normalized,d.colorSpace,d.isVideoTexture);Ze(z,d);let ue;const Ue=d.mipmaps,Fe=d.isVideoTexture!==!0,Ge=le.__version===void 0||X===!0,I=ie.dataReady,ae=T(d,J);if(d.isDepthTexture)pe=w(d.format===Gn,d.type),Ge&&(Fe?t.texStorage2D(i.TEXTURE_2D,1,pe,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,pe,J.width,J.height,0,he,Le,null));else if(d.isDataTexture)if(Ue.length>0){Fe&&Ge&&t.texStorage2D(i.TEXTURE_2D,ae,pe,Ue[0].width,Ue[0].height);for(let Z=0,de=Ue.length;Z<de;Z++)ue=Ue[Z],Fe?I&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ue.width,ue.height,he,Le,ue.data):t.texImage2D(i.TEXTURE_2D,Z,pe,ue.width,ue.height,0,he,Le,ue.data);d.generateMipmaps=!1}else Fe?(Ge&&t.texStorage2D(i.TEXTURE_2D,ae,pe,J.width,J.height),I&&Q(d,J,he,Le)):t.texImage2D(i.TEXTURE_2D,0,pe,J.width,J.height,0,he,Le,J.data);else if(d.isCompressedTexture)if(d.isCompressedArrayTexture){Fe&&Ge&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,pe,Ue[0].width,Ue[0].height,J.depth);for(let Z=0,de=Ue.length;Z<de;Z++)if(ue=Ue[Z],d.format!==qt)if(he!==null)if(Fe){if(I)if(d.layerUpdates.size>0){const Se=zo(ue.width,ue.height,d.format,d.type);for(const ee of d.layerUpdates){const Pe=ue.data.subarray(ee*Se/ue.data.BYTES_PER_ELEMENT,(ee+1)*Se/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,ee,ue.width,ue.height,1,he,Pe)}d.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ue.width,ue.height,J.depth,he,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Z,pe,ue.width,ue.height,J.depth,0,ue.data,0,0);else Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ue.width,ue.height,J.depth,he,Le,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Z,pe,ue.width,ue.height,J.depth,0,he,Le,ue.data)}else{Fe&&Ge&&t.texStorage2D(i.TEXTURE_2D,ae,pe,Ue[0].width,Ue[0].height);for(let Z=0,de=Ue.length;Z<de;Z++)ue=Ue[Z],d.format!==qt?he!==null?Fe?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,Z,0,0,ue.width,ue.height,he,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,Z,pe,ue.width,ue.height,0,ue.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?I&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ue.width,ue.height,he,Le,ue.data):t.texImage2D(i.TEXTURE_2D,Z,pe,ue.width,ue.height,0,he,Le,ue.data)}else if(d.isDataArrayTexture)if(Fe){if(Ge&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,pe,J.width,J.height,J.depth),I)if(d.layerUpdates.size>0){const Z=zo(J.width,J.height,d.format,d.type);for(const de of d.layerUpdates){const Se=J.data.subarray(de*Z/J.data.BYTES_PER_ELEMENT,(de+1)*Z/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,de,J.width,J.height,1,he,Le,Se)}d.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,he,Le,J.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,pe,J.width,J.height,J.depth,0,he,Le,J.data);else if(d.isData3DTexture)Fe?(Ge&&t.texStorage3D(i.TEXTURE_3D,ae,pe,J.width,J.height,J.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,he,Le,J.data)):t.texImage3D(i.TEXTURE_3D,0,pe,J.width,J.height,J.depth,0,he,Le,J.data);else if(d.isFramebufferTexture){if(Ge)if(Fe)t.texStorage2D(i.TEXTURE_2D,ae,pe,J.width,J.height);else{let Z=J.width,de=J.height;for(let Se=0;Se<ae;Se++)t.texImage2D(i.TEXTURE_2D,Se,pe,Z,de,0,he,Le,null),Z>>=1,de>>=1}}else if(d.isHTMLTexture){if("texElementImage2D"in i){const Z=i.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),J.parentNode!==Z){Z.appendChild(J),_.add(d),Z.onpaint=de=>{const Se=de.changedElements;for(const ee of _)Se.includes(ee.image)&&(ee.needsUpdate=!0)},Z.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,J);else{const Se=i.RGBA,ee=i.RGBA,Pe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Se,ee,Pe,J)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ue.length>0){if(Fe&&Ge){const Z=We(Ue[0]);t.texStorage2D(i.TEXTURE_2D,ae,pe,Z.width,Z.height)}for(let Z=0,de=Ue.length;Z<de;Z++)ue=Ue[Z],Fe?I&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,he,Le,ue):t.texImage2D(i.TEXTURE_2D,Z,pe,he,Le,ue);d.generateMipmaps=!1}else if(Fe){if(Ge){const Z=We(J);t.texStorage2D(i.TEXTURE_2D,ae,pe,Z.width,Z.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,he,Le,J)}else t.texImage2D(i.TEXTURE_2D,0,pe,he,Le,J);u(d)&&y(z),le.__version=ie.version,d.onUpdate&&d.onUpdate(d)}b.__version=d.version}function Ce(b,d,F){if(d.image.length!==6)return;const z=U(b,d),X=d.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+F);const ie=n.get(X);if(X.version!==ie.__version||z===!0){t.activeTexture(i.TEXTURE0+F);const le=Je.getPrimaries(Je.workingColorSpace),q=d.colorSpace===Rn?null:Je.getPrimaries(d.colorSpace),J=d.colorSpace===Rn||le===q?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,d.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,d.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,d.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const he=d.isCompressedTexture||d.image[0].isCompressedTexture,Le=d.image[0]&&d.image[0].isDataTexture,pe=[];for(let ee=0;ee<6;ee++)!he&&!Le?pe[ee]=f(d.image[ee],!0,r.maxCubemapSize):pe[ee]=Le?d.image[ee].image:d.image[ee],pe[ee]=st(d,pe[ee]);const ue=pe[0],Ue=s.convert(d.format,d.colorSpace),Fe=s.convert(d.type),Ge=M(d.internalFormat,Ue,Fe,d.normalized,d.colorSpace),I=d.isVideoTexture!==!0,ae=ie.__version===void 0||z===!0,Z=X.dataReady;let de=T(d,ue);Ze(i.TEXTURE_CUBE_MAP,d);let Se;if(he){I&&ae&&t.texStorage2D(i.TEXTURE_CUBE_MAP,de,Ge,ue.width,ue.height);for(let ee=0;ee<6;ee++){Se=pe[ee].mipmaps;for(let Pe=0;Pe<Se.length;Pe++){const Ae=Se[Pe];d.format!==qt?Ue!==null?I?Z&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe,0,0,Ae.width,Ae.height,Ue,Ae.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe,Ge,Ae.width,Ae.height,0,Ae.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe,0,0,Ae.width,Ae.height,Ue,Fe,Ae.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe,Ge,Ae.width,Ae.height,0,Ue,Fe,Ae.data)}}}else{if(Se=d.mipmaps,I&&ae){Se.length>0&&de++;const ee=We(pe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,de,Ge,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Le){I?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,pe[ee].width,pe[ee].height,Ue,Fe,pe[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ge,pe[ee].width,pe[ee].height,0,Ue,Fe,pe[ee].data);for(let Pe=0;Pe<Se.length;Pe++){const dt=Se[Pe].image[ee].image;I?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe+1,0,0,dt.width,dt.height,Ue,Fe,dt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe+1,Ge,dt.width,dt.height,0,Ue,Fe,dt.data)}}else{I?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ue,Fe,pe[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ge,Ue,Fe,pe[ee]);for(let Pe=0;Pe<Se.length;Pe++){const Ae=Se[Pe];I?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe+1,0,0,Ue,Fe,Ae.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Pe+1,Ge,Ue,Fe,Ae.image[ee])}}}u(d)&&y(i.TEXTURE_CUBE_MAP),ie.__version=X.version,d.onUpdate&&d.onUpdate(d)}b.__version=d.version}function Me(b,d,F,z,X,ie){const le=s.convert(F.format,F.colorSpace),q=s.convert(F.type),J=M(F.internalFormat,le,q,F.normalized,F.colorSpace),he=n.get(d),Le=n.get(F);if(Le.__renderTarget=d,!he.__hasExternalTextures){const pe=Math.max(1,d.width>>ie),ue=Math.max(1,d.height>>ie);X===i.TEXTURE_3D||X===i.TEXTURE_2D_ARRAY?t.texImage3D(X,ie,J,pe,ue,d.depth,0,le,q,null):t.texImage2D(X,ie,J,pe,ue,0,le,q,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),et(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,z,X,Le.__webglTexture,0,ke(d)):(X===i.TEXTURE_2D||X>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&X<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,z,X,Le.__webglTexture,ie),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Te(b,d,F){if(i.bindRenderbuffer(i.RENDERBUFFER,b),d.depthBuffer){const z=d.depthTexture,X=z&&z.isDepthTexture?z.type:null,ie=w(d.stencilBuffer,X),le=d.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;et(d)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ke(d),ie,d.width,d.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ke(d),ie,d.width,d.height):i.renderbufferStorage(i.RENDERBUFFER,ie,d.width,d.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,le,i.RENDERBUFFER,b)}else{const z=d.textures;for(let X=0;X<z.length;X++){const ie=z[X],le=s.convert(ie.format,ie.colorSpace),q=s.convert(ie.type),J=M(ie.internalFormat,le,q,ie.normalized,ie.colorSpace);et(d)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ke(d),J,d.width,d.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,ke(d),J,d.width,d.height):i.renderbufferStorage(i.RENDERBUFFER,J,d.width,d.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function oe(b,d,F){const z=d.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(d.depthTexture&&d.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const X=n.get(d.depthTexture);if(X.__renderTarget=d,(!X.__webglTexture||d.depthTexture.image.width!==d.width||d.depthTexture.image.height!==d.height)&&(d.depthTexture.image.width=d.width,d.depthTexture.image.height=d.height,d.depthTexture.needsUpdate=!0),z){if(X.__webglInit===void 0&&(X.__webglInit=!0,d.depthTexture.addEventListener("dispose",R)),X.__webglTexture===void 0){X.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Ze(i.TEXTURE_CUBE_MAP,d.depthTexture);const he=s.convert(d.depthTexture.format),Le=s.convert(d.depthTexture.type);let pe;d.depthTexture.format===xn?pe=i.DEPTH_COMPONENT24:d.depthTexture.format===Gn&&(pe=i.DEPTH24_STENCIL8);for(let ue=0;ue<6;ue++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,pe,d.width,d.height,0,he,Le,null)}}else $(d.depthTexture,0);const ie=X.__webglTexture,le=ke(d),q=z?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,J=d.depthTexture.format===Gn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(d.depthTexture.format===xn)et(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,q,ie,0,le):i.framebufferTexture2D(i.FRAMEBUFFER,J,q,ie,0);else if(d.depthTexture.format===Gn)et(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,q,ie,0,le):i.framebufferTexture2D(i.FRAMEBUFFER,J,q,ie,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function _e(b){const d=n.get(b),F=b.isWebGLCubeRenderTarget===!0;if(d.__boundDepthTexture!==b.depthTexture){const z=b.depthTexture;if(d.__depthDisposeCallback&&d.__depthDisposeCallback(),z){const X=()=>{delete d.__boundDepthTexture,delete d.__depthDisposeCallback,z.removeEventListener("dispose",X)};z.addEventListener("dispose",X),d.__depthDisposeCallback=X}d.__boundDepthTexture=z}if(b.depthTexture&&!d.__autoAllocateDepthBuffer)if(F)for(let z=0;z<6;z++)oe(d.__webglFramebuffer[z],b,z);else{const z=b.texture.mipmaps;z&&z.length>0?oe(d.__webglFramebuffer[0],b,0):oe(d.__webglFramebuffer,b,0)}else if(F){d.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer[z]),d.__webglDepthbuffer[z]===void 0)d.__webglDepthbuffer[z]=i.createRenderbuffer(),Te(d.__webglDepthbuffer[z],b,!1);else{const X=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=d.__webglDepthbuffer[z];i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,ie)}}else{const z=b.texture.mipmaps;if(z&&z.length>0?t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer),d.__webglDepthbuffer===void 0)d.__webglDepthbuffer=i.createRenderbuffer(),Te(d.__webglDepthbuffer,b,!1);else{const X=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=d.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,ie)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function re(b,d,F){const z=n.get(b);d!==void 0&&Me(z.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&_e(b)}function j(b){const d=b.texture,F=n.get(b),z=n.get(d);b.addEventListener("dispose",m);const X=b.textures,ie=b.isWebGLCubeRenderTarget===!0,le=X.length>1;if(le||(z.__webglTexture===void 0&&(z.__webglTexture=i.createTexture()),z.__version=d.version,a.memory.textures++),ie){F.__webglFramebuffer=[];for(let q=0;q<6;q++)if(d.mipmaps&&d.mipmaps.length>0){F.__webglFramebuffer[q]=[];for(let J=0;J<d.mipmaps.length;J++)F.__webglFramebuffer[q][J]=i.createFramebuffer()}else F.__webglFramebuffer[q]=i.createFramebuffer()}else{if(d.mipmaps&&d.mipmaps.length>0){F.__webglFramebuffer=[];for(let q=0;q<d.mipmaps.length;q++)F.__webglFramebuffer[q]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(le)for(let q=0,J=X.length;q<J;q++){const he=n.get(X[q]);he.__webglTexture===void 0&&(he.__webglTexture=i.createTexture(),a.memory.textures++)}if(b.samples>0&&et(b)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let q=0;q<X.length;q++){const J=X[q];F.__webglColorRenderbuffer[q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[q]);const he=s.convert(J.format,J.colorSpace),Le=s.convert(J.type),pe=M(J.internalFormat,he,Le,J.normalized,J.colorSpace,b.isXRRenderTarget===!0),ue=ke(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,ue,pe,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+q,i.RENDERBUFFER,F.__webglColorRenderbuffer[q])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),Te(F.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ie){t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture),Ze(i.TEXTURE_CUBE_MAP,d);for(let q=0;q<6;q++)if(d.mipmaps&&d.mipmaps.length>0)for(let J=0;J<d.mipmaps.length;J++)Me(F.__webglFramebuffer[q][J],b,d,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+q,J);else Me(F.__webglFramebuffer[q],b,d,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0);u(d)&&y(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(le){for(let q=0,J=X.length;q<J;q++){const he=X[q],Le=n.get(he);let pe=i.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(pe=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(pe,Le.__webglTexture),Ze(pe,he),Me(F.__webglFramebuffer,b,he,i.COLOR_ATTACHMENT0+q,pe,0),u(he)&&y(pe)}t.unbindTexture()}else{let q=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(q=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(q,z.__webglTexture),Ze(q,d),d.mipmaps&&d.mipmaps.length>0)for(let J=0;J<d.mipmaps.length;J++)Me(F.__webglFramebuffer[J],b,d,i.COLOR_ATTACHMENT0,q,J);else Me(F.__webglFramebuffer,b,d,i.COLOR_ATTACHMENT0,q,0);u(d)&&y(q),t.unbindTexture()}b.depthBuffer&&_e(b)}function fe(b){const d=b.textures;for(let F=0,z=d.length;F<z;F++){const X=d[F];if(u(X)){const ie=A(b),le=n.get(X).__webglTexture;t.bindTexture(ie,le),y(ie),t.unbindTexture()}}}const we=[],Ve=[];function Ye(b){if(b.samples>0){if(et(b)===!1){const d=b.textures,F=b.width,z=b.height;let X=i.COLOR_BUFFER_BIT;const ie=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,le=n.get(b),q=d.length>1;if(q)for(let he=0;he<d.length;he++)t.bindFramebuffer(i.FRAMEBUFFER,le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,le.__webglMultisampledFramebuffer);const J=b.texture.mipmaps;J&&J.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglFramebuffer);for(let he=0;he<d.length;he++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(X|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(X|=i.STENCIL_BUFFER_BIT)),q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,le.__webglColorRenderbuffer[he]);const Le=n.get(d[he]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Le,0)}i.blitFramebuffer(0,0,F,z,0,0,F,z,X,i.NEAREST),l===!0&&(we.length=0,Ve.length=0,we.push(i.COLOR_ATTACHMENT0+he),b.depthBuffer&&b.resolveDepthBuffer===!1&&(we.push(ie),Ve.push(ie),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ve)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,we))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),q)for(let he=0;he<d.length;he++){t.bindFramebuffer(i.FRAMEBUFFER,le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,le.__webglColorRenderbuffer[he]);const Le=n.get(d[he]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,Le,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,le.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const d=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[d])}}}function ke(b){return Math.min(r.maxSamples,b.samples)}function et(b){const d=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&d.__useRenderToTexture!==!1}function P(b){const d=a.render.frame;p.get(b)!==d&&(p.set(b,d),b.update())}function st(b,d){const F=b.colorSpace,z=b.format,X=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||F!==Pr&&F!==Rn&&(Je.getTransfer(F)===tt?(z!==qt||X!==Ft)&&Oe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):$e("WebGLTextures: Unsupported texture color space:",F)),d}function We(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=Y,this.resetTextureUnits=W,this.getTextureUnits=K,this.setTextureUnits=B,this.setTexture2D=$,this.setTexture2DArray=ne,this.setTexture3D=se,this.setTextureCube=ce,this.rebindTextures=re,this.setupRenderTarget=j,this.updateRenderTargetMipmap=fe,this.updateMultisampleRenderTarget=Ye,this.setupDepthRenderbuffer=_e,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=et,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function _m(i,e){function t(n,r=Rn){let s;const a=Je.getTransfer(r);if(n===Ft)return i.UNSIGNED_BYTE;if(n===La)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ia)return i.UNSIGNED_SHORT_5_5_5_1;if(n===bl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===El)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Sl)return i.BYTE;if(n===yl)return i.SHORT;if(n===Vi)return i.UNSIGNED_SHORT;if(n===Pa)return i.INT;if(n===an)return i.UNSIGNED_INT;if(n===tn)return i.FLOAT;if(n===_n)return i.HALF_FLOAT;if(n===Tl)return i.ALPHA;if(n===wl)return i.RGB;if(n===qt)return i.RGBA;if(n===xn)return i.DEPTH_COMPONENT;if(n===Gn)return i.DEPTH_STENCIL;if(n===Al)return i.RED;if(n===Da)return i.RED_INTEGER;if(n===Xn)return i.RG;if(n===Ua)return i.RG_INTEGER;if(n===Na)return i.RGBA_INTEGER;if(n===yr||n===br||n===Er||n===Tr)if(a===tt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===yr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===br)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Er)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Tr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===yr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===br)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Er)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Tr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ws||n===Xs||n===qs||n===Ys)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ws)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Xs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===qs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ys)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ks||n===Zs||n===$s||n===Js||n===Qs||n===Rr||n===js)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ks||n===Zs)return a===tt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===$s)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Js)return s.COMPRESSED_R11_EAC;if(n===Qs)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Rr)return s.COMPRESSED_RG11_EAC;if(n===js)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===ea||n===ta||n===na||n===ia||n===ra||n===sa||n===aa||n===oa||n===la||n===ca||n===ha||n===ua||n===da||n===fa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===ea)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ta)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===na)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ia)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ra)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===sa)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===aa)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===oa)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===la)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ca)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ha)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ua)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===da)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===fa)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===pa||n===ma||n===ga)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===pa)return a===tt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ma)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ga)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===_a||n===xa||n===Cr||n===va)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===_a)return s.COMPRESSED_RED_RGTC1_EXT;if(n===xa)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Cr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===va)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Gi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const xm=`
void main() {
...
void main() {
    ...
    `,document.head.appendChild(_e);const re=h.attributes.position;for(let j=0;j<g;j++){const fe=j%Xt.length,we=new D().fromBufferAttribute(re,j*3),Ve=new D().fromBufferAttribute(re,j*3+1),Ye=new D().fromBufferAttribute(re,j*3+2),ke=new D().addVectors(we,Ve).add(Ye).divideScalar(3),et=new D().subVectors(Ve,we),P=new D().subVectors(Ye,we),st=new D().crossVectors(et,P).normalize(),We=new D().subVectors(we,ke).normalize(),b=We.clone().addScaledVector(st,-We.dot(st)).normalize(),d=document.createElement("div");d.className="face-label",d.textContent=oe(fe),d.style.setProperty("--duration",`${4+Math.random()*6}s`),d.style.setProperty("--delay",`${-Math.random()*8}s`);const F=new Am(d);F.position.copy(ke.clone().multiplyScalar(1.01)),y.add(F),M.push({label:F,normal:st,upVec:b,div:d})}}const w=new Ne(15777888),T=new Ne(16097312);let R=-1,m=-1;function E(Te,oe){for(let _e=0;_e<3;_e++){const re=(Te*3+_e)*3;S[re]=oe.r,S[re+1]=oe.g,S[re+2]=oe.b}h.attributes.color.needsUpdate=!0}function L(Te){for(let oe=0;oe<3;oe++){const _e=(Te*3+oe)*3;S[_e]=f[_e],S[_e+1]=f[_e+1],S[_e+2]=f[_e+2]}h.attributes.color.needsUpdate=!0}const C=new Ph,O=new Be;let W=null,K=null,B=null,Y=null;if(!e){let oe=function(re){const j=re.dataset.target,fe=Xt.findIndex(we=>we.title===j);fe!==-1&&(K.style.transition="opacity .18s",B.style.transition="opacity .18s",K.style.opacity="0",B.style.opacity="0",setTimeout(()=>{B.textContent=Xt[fe].title,K.innerHTML=Xt[fe].text,Y.textContent=`Fragment ${fe+1} of ${Xt.length} · ${Xt[fe].title}`,K.scrollTop=0,K.style.opacity="1",B.style.opacity="1",K.querySelectorAll(".fragment-link").forEach(we=>{const Ve=(Math.random()*12).toFixed(1),Ye=(9+Math.random()*7).toFixed(1);we.style.animationDelay=`-${Ve}s`,we.style.animationDuration=`${Ye}s`,we.setAttribute("role","button"),we.setAttribute("tabindex","0"),we.setAttribute("aria-label",`Navigate to fragment: ${we.dataset.target}`)})},180))};var Me=oe;W=document.createElement("aside"),W.id="sphere-panel",W.setAttribute("role","dialog"),W.setAttribute("aria-modal","false"),W.setAttribute("aria-labelledby","sphere-panel-title"),W.innerHTML=`
    ...
    `,document.head.appendChild(Te),i.style.position="relative",i.style.overflow="hidden",i.appendChild(W),B=W.querySelector("#sphere-panel-title"),K=W.querySelector("#sphere-panel-content"),Y=W.querySelector("#sphere-facet-id"),W.addEventListener("click",re=>re.stopPropagation()),W.querySelector("#sphere-panel-close").addEventListener("click",re=>{re.stopPropagation(),W.classList.remove("open"),m!==-1&&(L(m),m=-1)}),K.addEventListener("click",re=>{const j=re.target.closest(".fragment-link");j&&(re.stopPropagation(),oe(j))}),K.addEventListener("keydown",re=>{if(re.key!=="Enter"&&re.key!==" ")return;const j=re.target.closest(".fragment-link");j&&(re.preventDefault(),re.stopPropagation(),oe(j))}),i.addEventListener("mousemove",re=>{const j=i.getBoundingClientRect();O.x=(re.clientX-j.left)/j.width*2-1,O.y=-((re.clientY-j.top)/j.height)*2+1,C.setFromCamera(O,s);const fe=C.intersectObject(y),we=fe.length?fe[0].faceIndex:-1;we!==R&&(R!==-1&&R!==m&&L(R),R=we,R!==-1&&R!==m&&E(R,w)),i.style.cursor=R!==-1?"pointer":"default"});let _e=!1;i.addEventListener("touchmove",()=>{_e=!0},{passive:!0}),i.addEventListener("touchstart",()=>{_e=!1},{passive:!0}),i.addEventListener("click",re=>{if(_e){_e=!1;return}if(W.classList.contains("open")&&!W.contains(re.target)){W.classList.remove("open"),m!==-1&&(L(m),m=-1);return}if(R===-1)return;m!==-1&&m!==R&&L(m),m=R,E(m,T);const j=m%Xt.length;B.textContent=Xt[j].title,K.innerHTML=Xt[j].text,Y.textContent=`Facet ${m} · Fragment ${j+1} of ${Xt.length}`,W.classList.add("open"),setTimeout(()=>B.focus(),50),K.querySelectorAll(".fragment-link").forEach(fe=>{const we=(Math.random()*12).toFixed(1),Ve=(9+Math.random()*7).toFixed(1);fe.style.animationDelay=`-${we}s`,fe.style.animationDuration=`${Ve}s`,fe.setAttribute("role","button"),fe.setAttribute("tabindex","0"),fe.setAttribute("aria-label",`Navigate to fragment: ${fe.dataset.target}`)})}),i.addEventListener("wheel",re=>{W&&W.contains(re.target)||(s.position.z=Math.max(1.8,Math.min(6,s.position.z+re.deltaY*.005)))})}let V=!1,$={x:0,y:0},ne=!0;i.addEventListener("mousedown",Te=>{V=!0,ne=!1,$={x:Te.clientX,y:Te.clientY}}),window.addEventListener("mouseup",()=>{V=!1,setTimeout(()=>{ne=!0},2e3)}),window.addEventListener("mousemove",Te=>{V&&(y.rotation.y+=(Te.clientX-$.x)*.005,y.rotation.x+=(Te.clientY-$.y)*.005,A.rotation.copy(y.rotation),$={x:Te.clientX,y:Te.clientY})});function se(){const Te=i.clientWidth,oe=i.clientHeight;s.aspect=Te/oe,s.updateProjectionMatrix(),a.setSize(Te,oe),o&&o.setSize(Te,oe)}window.addEventListener("resize",se);const ce=new D,ye=new D,Ke=new D,rt=new ze;function Ze(Te){const oe=Te.clone().project(s);return{x:(oe.x*.5+.5)*i.clientWidth,y:(-oe.y*.5+.5)*i.clientHeight}}let U=0,te;function Q(){if(te=requestAnimationFrame(Q),U+=.003,ne&&(y.rotation.y+=.0015,y.rotation.x+=3e-4,A.rotation.copy(y.rotation)),l.position.set(Math.cos(U)*5,3,Math.sin(U)*5),c.position.set(Math.cos(U+Math.PI)*4,Math.sin(U*.7)*2,Math.sin(U+Math.PI)*4),p.position.set(Math.sin(U*.5)*3,-3,Math.cos(U*.5)*3),!e&&M.length){s.getWorldDirection(ce),rt.getNormalMatrix(y.matrixWorld);const Te=s.position.z,oe=Math.max(.5,Math.min(3,3.8/Te));for(const{label:_e,normal:re,upVec:j,div:fe}of M){ye.copy(re).applyMatrix3(rt).normalize();const we=ye.dot(ce);if(we<-.1){const Ve=Math.min(.25,(-we-.1)*.35);fe.style.setProperty("--base-opacity",Ve.toFixed(3)),fe.style.visibility="visible",_e.visible=!0,fe.style.fontSize=`${(7*oe).toFixed(1)}px`,fe.style.width=`${(60*oe).toFixed(0)}px`,fe.style.height=`${(52*oe).toFixed(0)}px`;const Ye=_e.position.clone().applyMatrix4(y.matrixWorld);Ke.copy(j).applyMatrix3(rt).normalize();const ke=Ye.clone().addScaledVector(Ke,.15),et=Ze(Ye),P=Ze(ke),st=Math.atan2(P.x-et.x,-(P.y-et.y))*(180/Math.PI);fe.style.transform=`rotate(${st.toFixed(1)}deg)`}else fe.style.visibility="hidden",_e.visible=!1}}a.render(r,s),o&&o.render(r,s)}return Q(),{dispose(){cancelAnimationFrame(te),window.removeEventListener("resize",se),a.dispose(),o&&o.domElement.remove(),W&&W.remove(),a.domElement.remove()}}}const Pm=10,Lm=28,Im=8/3,Ls=.005,Is=[{x:.1,y:0,z:20,color:new Ne(1,1,.95)},{x:.100001,y:0,z:20,color:new Ne(1,.82,.28)},{x:.1,y:1e-6,z:20,color:new Ne(1,.45,.05)},{x:.1,y:0,z:20.000001,color:new Ne(1,.62,.12)},{x:-.1,y:0,z:20,color:new Ne(1,.38,0)},{x:.1,y:2e-6,z:20,color:new Ne(1,.28,.04)},{x:.100002,y:0,z:20,color:new Ne(1,.88,.45)}];function wa(i){const e=Pm*(i.y-i.x),t=i.x*(Lm-i.z)-i.y,n=i.x*i.y-Im*i.z;i.x+=e*Ls,i.y+=t*Ls,i.z+=n*Ls}function Dm(i){const e={x:.1,y:0,z:20};for(let c=0;c<2e3;c++)wa(e);let t=1/0,n=-1/0,r=1/0,s=-1/0,a=1/0,o=-1/0;const l={...e};for(let c=0;c<6e3;c++)wa(l),t=Math.min(t,l.x),n=Math.max(n,l.x),r=Math.min(r,l.y),s=Math.max(s,l.y),a=Math.min(a,l.z),o=Math.max(o,l.z);return{x:(t+n)/2*i,y:(r+s)/2*i,z:(a+o)/2*i}}function Um(i,{preview:e=!1,shorts:t=!1,rotSpeed:n=1}={}){const r=t||!e&&new URLSearchParams(window.location.search).has("shorts"),s=r?Math.min(i.clientWidth||window.innerWidth,450):i.clientWidth||window.innerWidth,a=r?Math.round(s*(16/9)):i.clientHeight||window.innerHeight,o=e?.7:1.6,l=e?3e3:1e4,c=e?0:300,p=e?2:4,_=new Ll;_.fog=new ka(0,e?.012:.006);const h=new Nt(45,s/a,.1,500);h.position.set(e?5:40,e?15:r?30:35,e?65:r?100:130),h.lookAt(0,e?5:0,0);const g=new Zl({antialias:!0,alpha:!0});g.setPixelRatio(window.devicePixelRatio),g.setSize(s,a),g.setClearColor(0,0),g.domElement.setAttribute("aria-hidden","true"),r?(g.domElement.style.width=s+"px",g.domElement.style.height=a+"px",g.domElement.style.display="block",g.domElement.style.margin="0 auto"):(g.domElement.style.width="100%",g.domElement.style.height="100%",g.domElement.style.display="block"),i.appendChild(g.domElement);const x=Dm(o);let S=[],f=[];if(!e){let Te=function(_e,re,j,fe,we,Ve,Ye,ke=1){const et=[],P=[];for(let d=0;d<=ke;d++){const F=d/ke,z=_e+(fe-_e)*F,X=re+(we-re)*F,ie=j+(Ve-j)*F;et.push(z,X,ie),P.push({x:z,y:X,z:ie})}const st=new Float32Array(et),We=new Pt;We.setAttribute("position",new St(st,3));const b=new ys(We,Ye);return _.add(b),S.push({geo:We,posArr:st,vertexCount:ke+1}),f.push(...P),{startIdx:f.length-P.length,count:P.length}};var rt=Te;const ve=new mi({color:14477557,transparent:!0,opacity:.28,depthWrite:!1}),Ce=new mi({color:13162734,transparent:!0,opacity:.13,depthWrite:!1}),Me=new mi({color:12111072,transparent:!0,opacity:.09,depthWrite:!1}),oe=4;for(let _e=-80;_e<=80;_e+=10){const re=Math.abs(_e)%20===0?ve:Ce;for(let j=-80;j<=80;j+=10)Te(j,-80,_e,j,80,_e,re,oe);for(let j=-80;j<=80;j+=10)Te(-80,j,_e,80,j,_e,re,oe)}for(let _e=-80;_e<=80;_e+=10)for(let re=-80;re<=80;re+=10)Te(_e,re,-80,_e,re,80,Me,oe)}const u=new Bi;_.add(u);const y=Is.map(U=>{const te=new Float32Array(l*3),Q=new Float32Array(l*3),ve=new Pt;ve.setAttribute("position",new St(te,3)),ve.setAttribute("color",new St(Q,3)),ve.setDrawRange(0,0);const Ce=new mi({vertexColors:!0,transparent:!1,blending:Ar,depthWrite:!1}),Me=new ys(ve,Ce);return Me.position.set(-x.x,-x.y,-x.z),u.add(Me),{state:{...U},color:U.color,posArray:te,colArray:Q,geo:ve,count:0,head:0}}),A=e?[]:Is.map(U=>{const te=new Float32Array(c*3),Q=new Float32Array(c*3),ve=new Pt;ve.setAttribute("position",new St(te,3)),ve.setAttribute("color",new St(Q,3)),ve.setDrawRange(0,0);const Ce=new mi({vertexColors:!0,transparent:!0,opacity:.55,blending:Ar,depthWrite:!1}),Me=new ys(ve,Ce);return Me.position.set(-x.x,-x.y,-x.z),u.add(Me),{color:U.color,posArray:te,colArray:Q,geo:ve,count:0,head:0}}),M=[];if(!e){let te=function(ve){const Ce=document.createElement("canvas");Ce.width=128,Ce.height=64;const Me=Ce.getContext("2d");return Me.font="italic 22px Times New Roman,serif",Me.fillStyle="rgba(200,220,255,0.7)",Me.textAlign="center",Me.textBaseline="middle",Me.fillText(ve,64,32),new mh(Ce)};var Ze=te;const Q=["σ","ρ","β","λ","∂","∇","∞","π","Δ","ω","φ","ψ","θ","α","dx/dt","dy/dt","dz/dt","σ(y−x)","8/3","28","10","f(x)","∫","∑","lim","→","ℝ³","ẋ","ẏ","ż","βz","ρ−z"].map(te);for(let ve=0;ve<220;ve++){const Ce=new Ul({map:Q[Math.floor(Math.random()*Q.length)],transparent:!0,opacity:.2+Math.random()*.3,depthWrite:!1}),Me=new ch(Ce);Me.position.set((Math.random()-.5)*140,(Math.random()-.5)*140,(Math.random()-.5)*140);const Te=2.5+Math.random()*4.5;Me.scale.set(Te*2,Te,1),_.add(Me),M.push({sprite:Me,vel:{x:(Math.random()-.5)*.008,y:(Math.random()-.5)*.006,z:(Math.random()-.5)*.005},phase:Math.random()*Math.PI*2,speed:.003+Math.random()*.005,baseOpacity:.06+Math.random()*.14})}}let w={radius:h.position.length(),phi:Math.acos(h.position.y/h.position.length()),theta:Math.atan2(h.position.x,h.position.z)};const T=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let R=!1,m={x:0,y:0},E=!T,L=!e&&!T;const C=(r?.0015:8e-4)*n;function O(){h.position.x=w.radius*Math.sin(w.phi)*Math.sin(w.theta),h.position.y=w.radius*Math.cos(w.phi),h.position.z=w.radius*Math.sin(w.phi)*Math.cos(w.theta),h.lookAt(0,0,0)}e||(i.addEventListener("mousedown",U=>{R=!0,E=!1,m={x:U.clientX,y:U.clientY}}),window.addEventListener("mouseup",()=>{R=!1,setTimeout(()=>{E=!0},3e3)}),window.addEventListener("mousemove",U=>{R&&(w.theta-=(U.clientX-m.x)*.005,w.phi=Math.max(.1,Math.min(Math.PI-.1,w.phi+(U.clientY-m.y)*.005)),m={x:U.clientX,y:U.clientY})}),i.addEventListener("wheel",U=>{w.radius=Math.max(40,Math.min(220,w.radius+U.deltaY*.08))}),i.addEventListener("touchstart",U=>{R=!0,E=!1,m={x:U.touches[0].clientX,y:U.touches[0].clientY}},{passive:!0}),window.addEventListener("touchend",()=>{R=!1,setTimeout(()=>{E=!0},3e3)}),window.addEventListener("touchmove",U=>{R&&(w.theta-=(U.touches[0].clientX-m.x)*.005,w.phi=Math.max(.1,Math.min(Math.PI-.1,w.phi+(U.touches[0].clientY-m.y)*.005)),m={x:U.touches[0].clientX,y:U.touches[0].clientY})},{passive:!0}));function W(){const U=i.clientWidth,te=i.clientHeight;h.aspect=U/te,h.updateProjectionMatrix(),g.setSize(U,te)}window.addEventListener("resize",W);let K=0,B=0,Y=0,V=-1.52,$=0,ne=.05,se=0,ce;const ye=new D;function Ke(){ce=requestAnimationFrame(Ke),se+=.008,E&&(K=K*.96+(Math.random()-.5)*8e-4,B=B*.96+(Math.random()-.5)*.0012,Y=Y*.96+(Math.random()-.5)*4e-4,K+=(-1.52-V)*.003,B+=(0-$)*.002,Y+=(.05-ne)*.002,V+=K,$+=B,ne+=Y,u.rotation.x=V,u.rotation.y=$,u.rotation.z=ne),L&&!R?(w.theta+=C,O()):e||O();for(const U of y){for(let te=0;te<p;te++){wa(U.state);const Q=U.head%l*3;U.posArray[Q]=U.state.x*o,U.posArray[Q+1]=U.state.y*o,U.posArray[Q+2]=U.state.z*o;const ve=U.count<l?.3+U.count/l*.7:1;U.colArray[Q]=U.color.r*ve,U.colArray[Q+1]=U.color.g*ve,U.colArray[Q+2]=U.color.b*ve,U.head++,U.count=Math.min(U.count+1,l)}U.geo.attributes.position.needsUpdate=!0,U.geo.attributes.color.needsUpdate=!0,U.geo.setDrawRange(0,U.count)}if(!e){for(let j=0;j<Is.length;j++){const fe=y[j],we=A[j];for(let Ve=0;Ve<p;Ve++){const Ye=(fe.head-p+Ve+l)%l*3,ke=we.head%c*3;we.posArray[ke]=fe.posArray[Ye],we.posArray[ke+1]=fe.posArray[Ye+1],we.posArray[ke+2]=fe.posArray[Ye+2],we.colArray[ke]=Math.min(1,fe.color.r*1.4),we.colArray[ke+1]=Math.min(1,fe.color.g*1.4),we.colArray[ke+2]=Math.min(1,fe.color.b*1.4),we.head++,we.count=Math.min(we.count+1,c)}we.geo.attributes.position.needsUpdate=!0,we.geo.attributes.color.needsUpdate=!0,we.geo.setDrawRange(0,we.count)}const U=y[0],te=(U.head-1+l)%l*3,Q=U.posArray[te]-x.x,ve=U.posArray[te+1]-x.y,Ce=U.posArray[te+2]-x.z;ye.set(Q,ve,Ce).applyEuler(u.rotation);const Me=40,Te=18,oe=4;let _e=0;for(const{geo:j,posArr:fe,vertexCount:we}of S){for(let Ve=0;Ve<we;Ve++){const Ye=f[_e],ke=Ye.x,et=Ye.y,P=Ye.z,st=ye.x-ke,We=ye.y-et,b=ye.z-P,d=st*st+We*We+b*b,F=Math.sqrt(d),z=Math.min(Me/(d+Te),oe/Math.max(F,.001));fe[Ve*3]=ke+st*z,fe[Ve*3+1]=et+We*z,fe[Ve*3+2]=P+b*z,_e++}j.attributes.position.needsUpdate=!0}const re=70;for(const j of M){j.vel.x+=(Math.random()-.5)*.001,j.vel.x*=.99,j.vel.y+=(Math.random()-.5)*.001,j.vel.y*=.99,j.vel.z+=(Math.random()-.5)*5e-4,j.vel.z*=.99,j.sprite.position.x+=j.vel.x,j.sprite.position.y+=j.vel.y,j.sprite.position.z+=j.vel.z;for(const fe of["x","y","z"])j.sprite.position[fe]>re&&(j.sprite.position[fe]=-re),j.sprite.position[fe]<-re&&(j.sprite.position[fe]=re);j.sprite.material.opacity=j.baseOpacity+Math.sin(se*j.speed*10+j.phase)*j.baseOpacity*.4}}g.render(_,h)}return Ke(),{dispose(){cancelAnimationFrame(ce),window.removeEventListener("resize",W),g.dispose(),g.domElement.remove()}}}const Aa={sphere:{create:Cm,label:"The Sphere — full screen experience. Press Escape to return.",ariaLabel:"The Sphere — interactive geodesic sphere with text fragments."},butterfly:{create:Um,label:"Chaos Butterfly in Phase Space, 2026.",ariaLabel:"Chaos Butterfly in Phase Space, 2026 — Lorenz attractor. Drag to orbit, scroll to zoom."}};let Ei=null,Hn=null;const gi=document.getElementById("experience-overlay"),ki=document.getElementById("experience-container"),$l=document.getElementById("landing"),Jl=document.getElementById("site-title"),Ql=document.createElement("style");Ql.textContent=`
  #butterfly-exp-label {
    position: fixed;
