...
<p>It also makes a sound: a small bell, struck three times. Nerve couriers racing along the strands. It is a <strong>shell</strong> rather than a bar &mdash; partials at 1 : 1.63 : 2.13 : 2.87 : 3.71 : 5.03, which is the region a small hemispherical bell's modes sit in, and not the steeply climbing 1 : 2.76 : 5.40 : 8.93 of a free bar, which is a xylophone. Every partial is a <strong>doublet</strong>, two frequencies a hair apart that beat against each other at between 1.7 and 9.4&nbsp;Hz: no real bell is perfectly symmetric, and that shimmer is the thing that says bell before anything else does. The attack is 4&nbsp;ms, the ring reaches &minus;60&nbsp;dB at 1.8&nbsp;s, and the sound stays bright the whole way down.</p>
